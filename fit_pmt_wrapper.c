...
Int_t fit_pmt_wrapper(string rootFile, Int_t runID, Int_t fitID, Int_t runNum, Int_t daq, Int_t pedRate, Int_t dataRate, Int_t chan, Int_t pmt, Int_t base, Int_t hv, Int_t ll, Int_t filter, Int_t lowRangeThresh = 15, Int_t highRangeThresh = 15, Int_t constrainInj = 100, Int_t constrainGain = -1, Int_t constrainLL = -1, Int_t saveResults = 0, Int_t saveNN = 0, Int_t fitEngine = 0, Int_t noExpo = 0){
	...
	lightLevels[1][60] = 15.23;
	lightLevels[1][70] = 50.5;
	lightLevels[1][80] = 150.0;
	lightLevels[1][90] = 383.0;
	lightLevels[1][100] = 768.0;
	// Setup PMT 2
	gainLevels[2][0] = 4.75;
	gainLevels[2][1] = 4.50;
	gainLevels[2][2] = 3.9;
	...
	lightLevels[2][60] = 12.61;
	lightLevels[2][70] = 48.0;
	lightLevels[2][80] = 196.0;
	lightLevels[2][90] = 359.0;
	...
	gainLevels[3][9] = 1.1;
	gainLevels[3][10] = 0.9;
	gainLevels[3][11] = 0.77;
	gainLevels[3][12] = 0.60;
	gainLevels[3][13] = 0.48;
	gainLevels[3][14] = 0.31;
	gainLevels[3][15] = 0.193;
	gainLevels[3][16] = 0.107;
	gainLevels[3][17] = 0.057;
	gainLevels[3][18] = 0.027;
	...
	lightLevels[3][90] = 383.0;
	lightLevels[3][100] = 770.0;
	// Setup PMT 4
	gainLevels[4][0] = 3.59;
	gainLevels[4][1] = 3.28;
	gainLevels[4][2] = 2.88;
